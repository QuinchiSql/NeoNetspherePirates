...
namespace NeoNetsphere.Resource.xml
{
    ...
    {
        [XmlElement("item")]
        public ItemInfoInfoDto_2[] item { get; set; }
    }

    [XmlType(AnonymousType = true)]
    public class ItemInfoInfoDto_2
    {
        [XmlAttribute("item_key")]
        public uint item_key { get; set; }

        [XmlElement("base")]
        public ItemBaseInfoDto_2 Base { get; set; }

        [XmlElement("graphic")]
        public ItemGraphicInfoDto_2 graphic { get; set; }

        [XmlElement("esperchip")]
        public ItemEsperChipInfoDto_2 esperchip { get; set; }

        [XmlElement("etc")]
        public ItemEtcInfoDto_2 etc { get; set; }

        [XmlElement("sequence")]
        public ItemSequenceInfoDto_2 sequence { get; set; }
    }
    ...
    public class ItemBaseInfoDto_2
    {
        ...
        [XmlAttribute("attrib_comment_key")]
