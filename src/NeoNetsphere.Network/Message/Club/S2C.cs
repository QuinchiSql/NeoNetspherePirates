...
namespace NeoNetsphere.Network.Message.Club
{
    ...
    public class ClubInfoAckMessage : IClubMessage
    {
        ...
        public ClubInfoAckMessage(ClubSearchInfoDto info)
        {
            Info = info;
        }
    }
    ...
    [BlubContract]
    public class ClubInfoAck2Message : IClubMessage
    {
        [BlubMember(0)]
        public ClubSearchInfoDto Info { get; set; }

        public ClubInfoAck2Message()
        {
        }

        public ClubInfoAck2Message(ClubSearchInfoDto info)
        {
            Info = info;
        }
    }
